...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    */
    ...
    Route::prefix('umkm')->name('umkm.')->group(function () {
        ...
        // AI Coupon Package
        Route::get('ai-coupons/redeem', [\App\Http\Controllers\AiCouponRedeemController::class, 'index'])->name('ai-coupons.redeem');
        Route::post('ai-coupons/redeem', [\App\Http\Controllers\AiCouponRedeemController::class, 'store'])->name('ai-coupons.store');
    ...
    */
    Route::prefix('admin')->name('admin.')->middleware(RoleCheck::class . ':admin')->group(function () {
        ...
        Route::get('ai-coupons', [\App\Http\Controllers\Admin\AiCouponController::class, 'index'])->name('ai-coupons.index');
        Route::post('ai-coupons', [\App\Http\Controllers\Admin\AiCouponController::class, 'store'])->name('ai-coupons.store');
        Route::patch('ai-coupons/{coupon}/toggle', [\App\Http\Controllers\Admin\AiCouponController::class, 'toggle'])->name('ai-coupons.toggle');
        Route::delete('ai-coupons/{coupon}', [\App\Http\Controllers\Admin\AiCouponController::class, 'destroy'])->name('ai-coupons.destroy');
    });
});
