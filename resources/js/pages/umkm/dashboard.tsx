...
import { Sparkles, Video, Image, Bot, ArrowRight, Clock, Wand2, Ticket } from 'lucide-react';
...
export default function UmkmDashboard({ store, aiStats, recentContents, aiCredits }: Props) {
    ...
    return (
        <AppLayout activeTab="dashboard">
            ...
            <div className="px-4 py-5 space-y-5 -mt-3">
                <Link
                    href="/umkm/ai-coupons/redeem"
                    className="block rounded-2xl border border-blue-100 bg-white p-4 shadow-sm active:scale-[0.98] transition-all"
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="font-bold text-foreground">Paket AI</p>
                            <p className="text-sm text-muted-foreground">
                                Video: {aiCredits.video_credits} tersisa, Foto percantik: {aiCredits.photo_enhance_credits} tersisa
                            </p>
                        </div>
